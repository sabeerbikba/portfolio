...
<template>
  <div class="min-h-screen w-full overflow-x-hidden text-white py-12 px-4 sm:px-6 lg:px-8 lg:py-28 lg:table">

    <div class="max-w-7xl mx-auto lg:table-cell lg:align-middle lg:text-center">
      <transition name="fade-slide-up">
        <div class="text-center mb-12 max-lg:mb-2" aria-labelledby="get-in-touch-heading">
          <h1 id="get-in-touch-heading" class="text-4xl font-extrabold sm:text-5xl md:text-6xl text-black mb-2">
            Get in Touch
          </h1>
          <h2 class="text-2xl font-extrabold sm:text-3xl md:text-4xl text-black/70">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div>
            <div
              ...
              role="form" aria-labelledby="contactFormTitle">
                ...
                <div class="max-w-xl mx-auto">
                  <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
                    <UiLabelInputContainer>
                      ...
                      <UiInput id="name" type="text" v-model="name" placeholder="Your name" minlength="3" maxlength="70"
                  ...
                  <UiLabelInputContainer class="mb-4">
                    ...
                    <UiInput id="email" type="email" v-model="email" placeholder="you@example.com" required
                      aria-required="true" aria-describedby="emailDescription" />
                    <small id="emailDescription" class="sr-only">Please enter a valid email address.</small>
                  </UiLabelInputContainer>
                  ...
                  <button
                    ...
                    type="submit" :disabled="status === 'Sending'" :aria-busy="status === 'Sending'"
                    :aria-live="status === 'Sending' ? 'polite' : 'assertive'" :aria-label="status">
                    <span class="flex items-center justify-center">
                      <i v-if="status === 'Send'" class="icon-send"></i>
                      <i v-else-if="status === 'Sent'" class="icon-check-circle"></i>
                ...
                <div class="lg:table">
                  <div class="lg:table-cell lg:align-middle lg:text-center">
                    <div class="mb-6 w-full">
                      <h1 class="text-3xl md:text-4xl font-bold text-black text-start lg:pl-6 center">
                        Sabeer Bikba
                      </h1>
                      <h2
                    ...
                    <div class="space-y-4 mb-8">
                      <div v-for="(item, index) in contactInfo" :key="index" class="center space-x-3 ml-2">
                        <UiExternalLink :href="item.href"
                          class="pr-2 text-gray-600 hover:text-gray-800 center text-base sm:text-lg md:text-xl"
                          :aria-label="item.ariaLabel">
                          <div class="w-7 sm:w-9 md:w-10 h-7 sm:h-9 md:h-10 mr-2 rounded-full bg-gray-100 center"
                    ...
                    <div class="flex justify-center space-x-4">
                      <UiExternalLink v-for="link in socialMedia" :key="link.label" :href="link.href"
    ...
    <transition name="fade">
      <div
        ...
        <NuxtLink to="/" aria-label="Back to home page" title="Back to home page"
          class="flex items-center justify-center rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black">
          <IoIosArrowBack class="md:h-9 md:w-9 lg:h-12 lg:w-12 h-[30px] w-[30px] relative right-0.5"
            aria-hidden="true" />
        </NuxtLink>
      </div>
    </transition>
