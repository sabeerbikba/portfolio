...
import { octiconsIcons, type OcticonsIconName } from "~/content/icons";
...
<template>
  <svg
    ...
    fill="currentColor"
    focusable="false"
    class="inline-block select-none align-text-bottom overflow-visible"
    v-html="octiconsIcons[name]"
  />
</template>
