    ...
    <html lang="en">
      <body>
        <main>
          ...
          <div className="h-[50rem] w-full h-full dark:bg-black bg-white dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative ">
