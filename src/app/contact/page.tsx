      ...
      <div className="max-w-7xl mx-auto">
         ...
         >
            <h1 className="text-4xl font-extrabold sm:text-5xl md:text-6xl">
               ...
               <span className="block text-blue-400">Let's Create Something Amazing</span>
            </h1>
         ...
         <div className="mt-10 sm:mt-12">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
               ...
               <ContactForm className="grid grid-cols-1 gap-y-6 bg-[#00000021]" />
               {/* <Form /> */}
               ...
               <motion.div
                  ...
                  className="p-8 rounded-lg shadow-lg bg-[#00000021]"
               >
