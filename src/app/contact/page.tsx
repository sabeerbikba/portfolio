...
import { Mail, Phone, MapPin, Send, Loader2, Github, Twitter, Linkedin } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto lg:table-cell lg:align-middle lg:text-center">
         ...
         <div className="mt-10 max-lg:mt-2">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
               ...
               <ContactForm className="p-8 rounded-lg shadow-lg grid grid-cols-1 gap-y-6 bg-[#00000008] border border-[#8080804f] max-lg:w-[80%] max-lg:mx-auto max-sm:w-full" />
               ...
               <motion.div
                  ...
                  className="p-8 rounded-lg shadow-lg bg-[#00000008] border border-[#8080804f] max-lg:w-[80%] max-lg:mx-auto max-sm:w-full"
               >
